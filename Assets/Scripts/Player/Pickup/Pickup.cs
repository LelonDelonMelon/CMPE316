...
public class Pickup : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            if (Input.GetKey(KeyCode.E))
            {
                ...
                if(hit.transform.gameObject.layer == 7)
                {
                    if (heldObject == null)
                    {
                        ...
                        // Move the hit object to the player's hand
                        heldObject.transform.position = handTransform.transform.position;
        ...
        if (heldObject != null)
        {
            ...
            Vector3 newPosition = orientation.position + handTransform.TransformDirection(distanceOffset);
    ...
    public void UpdateHandRotation(Quaternion rotation)
    {
